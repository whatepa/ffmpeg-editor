...
const App = () => {
  ...
  return (
    loaded && (
      <div className="grid h-screen mx-2 2xl:grid xl:grid xl:grid-cols-5 2xl:grid-cols-4 text-zinc-200">
        {video ? (
          <>
            <div className="2xl:col-span-3 2xl:col-start-1 xl:col-start-1 xl:col-span-4">
              <div className="top-0 grid h-10 grid-cols-4 bg-zinc-900">
                {video && <VideoUpload onChange={handleUploadedVideo} />}
                <input
                ...
                ></input>
                {
                  <div className="self-center col-span-1 text-end">
                    {videos.length > 1 ? (
                      <button
                        className="p-2 rounded cursor-pointer bg-zinc-800 hover:bg-zinc-700"
                        onClick={undoChanges}
                      >
                        <ArrowUturnLeftIcon className="w-5 h-5" />
                      </button>
                    ) : (
                      <button className="p-2 rounded opacity-50 pointer-events-none bg-zinc-800 hover:bg-zinc-700">
                        <ArrowUturnLeftIcon className="w-5 h-5" />
                      </button>
                    )}
                    {tempsRef.current.video ? (
                      <button
                        className="p-2 rounded cursor-pointer bg-zinc-800 hover:bg-zinc-700"
                ...
                {output !== null ? (
                  <a
                    className="flex items-center gap-1 p-2 rounded cursor-pointer place-self-end w-fit bg-zinc-800 hover:bg-zinc-700"
                    href={URL.createObjectURL(output)}
                  ...
                  <a className="flex items-center gap-1 p-2 rounded opacity-50 pointer-events-none place-self-end w-fit bg-zinc-800 hover:bg-zinc-700">
                    <p>Download</p>
                    <ArrowDownTrayIcon className="w-5 h-5" />
                  </a>
                )}
              ...
              {transcoding && (
                <div className="fixed inset-0 flex items-center justify-center opacity-50 bg-zinc-950 ">
